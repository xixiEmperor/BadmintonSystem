...
                "title": "测试帖子标题",
                "author": "zhangsan",
                "avatar": "http://localhost:8080/uploads/avatars/ba9d87aa-5716-43ea-a4f6-b8f43c7c4652.jpg",
                "category": "求助问答",
                "categoryCode": "help",
                "views": 0,
                "replies": null,
                "likes": 0,
                "publishTime": "2025-05-15T12:36:19.000+0000",
                "lastReply": "2025-05-15T12:36:19.000+0000"
            }
        ]
    }
=======
  ...
  "data": [
      {
        ...
        "views": "number", // 浏览次数
        "likes": "number", // 点赞数
        "replies": "number", // 回复数   //后端replies 改为replyCount
        "lastReply": "string", // 最后回复时间，格式：YYYY-MM-DD
        "category": "string" // 分类：team(打球组队)、notice(公告通知)、help(求助问答)、exp(经验交流)
      }
    ]
>>>>>>> b5847c06d3245fd34adb0149856878d0b5a7205f
}
```
